...
const PullTotalSemesters = () => {
  ...
  const apiUrl = `https://knj.horus.edu.eg/api/hue/portal/v1/CurrentSemesters&student_id=${StuId}`;
  ...
  return (
    <div className="flex-wrap justify-center flex items-baseline gap-6">
