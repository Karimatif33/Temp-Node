...
const GetCatQuesServData = () => {
  const [status, setStatus] = useState(null);
  const [isLoading, setIsLoading] = useState(false);
  const [error, setError] = useState(null);
  const apiUrl = `https://knj.horus.edu.eg/api/hue/portal/v1/CatQuesServData`;
  ...
  const handlePullData = async () => {
    try {
      ...
      if(setIsLoading){
        ...
        toast.success('CatQuesServ Loading...')
      }
...
export default GetCatQuesServData;
